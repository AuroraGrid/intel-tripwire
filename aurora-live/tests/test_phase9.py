...
class Phase9Tests(unittest.TestCase):
    ...
    def test_aggregator_publishes_registry_and_live_totals(self):
        ...
        with patch("phase9_engine.repaired_registry_manifest", return_value=[{"name": "Test", "provider": "Test Provider", "capability": "test_capability", "official": True, "tier": 1, "runtime": {}}]):
