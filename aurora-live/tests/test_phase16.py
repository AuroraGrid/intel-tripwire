...
class Phase16Tests(unittest.TestCase):
    ...
    def test_independent_provider_corroboration_confirms_detection(self):
        self.ingest("seismic.usgs", {"external_id": "usgs-2", "title": "Magnitude 6.1 earthquake near Kabul", "observed_at": "2026-07-20T10:00:00Z", "latitude": 34.50, "longitude": 69.20})
    ...
    def test_same_provider_duplicate_does_not_inflate_support(self):
        self.ingest("seismic.usgs", {"external_id": "usgs-3", "title": "Magnitude 5.8 earthquake near Herat", "observed_at": "2026-07-20T11:00:00Z", "latitude": 34.3, "longitude": 62.2})
        self.engine.process_pending(self.actor)
    ...
    def test_explicit_contradiction_disputes_detection(self):
        ...
        self.assertTrue(any(item["to_status"] == "DISPUTED" for item in detection["claim"]["revisions"]))
