...
class Phase18Application(Phase17Application):
    ...
    def _graph_response(self, path, method, actor, environ):
        ...
        if path == "/api/platform/graph/entities" and method == "POST":
        ...
        if len(parts) == 5 and parts[:4] == ["api", "platform", "graph", "entities"] and method == "GET":
            return 200, self.graph_engine.entity(actor, parts[4], include_inactive=True)
