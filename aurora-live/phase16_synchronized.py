...
class DetectionEngine(BaseDetectionEngine):
    """Phase 16 engine with explicit contradiction synchronization into the claim ledger."""
    ...
    def _mark_claim_disputed(self, actor, claim_id, detection_id, observation):
        ...
        with self.store.db() as connection:
            ...
            connection.execute(
                ...
                id,workspace_id,claim_id,from_status,to_status,from_confidence,to_confidence,
